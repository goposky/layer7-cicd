...
gmu_migrateIn_cmd = "gmu migrateIn --argFile " + args.argFile + " --results " + args.results + " --bundle " + args.bundle + " --destFolder " + service_folderpath + " --map " + base_folder + "/src/" + file_name + "-mapping.xml" + " --template " + base_folder + "/conf/" + file_name + ".properties" + " --plaintextEncryptionPassphrase " + args.plaintextEncryptionPassphrase
